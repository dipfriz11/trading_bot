"""
test_grid_freeform_long_live.py

Freeform live reconcile test — LONG, SIRENUSDT.

Session starts with full config (5 levels, Reset TP on [3,4,5], SL, main TP).
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"\n  watcher started  SL_PCT={SL_PCT}%  TP_PCT={TP_PCT}%  RESET_CLOSE={RESET_CLOSE_PCT}%")
